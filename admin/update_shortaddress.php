<html>
    ...
    $sql = 'SELECT id,full_address FROM '.$tbl.';'; // 送信するクエリ
    ...
    while($row = mysql_fetch_assoc($result)){
        preg_match("/(大阪府|京都府|北海道|東京都|[一-龠]+[県]){1}([一-龠ぁ-ヶ]+[市区郡町村]){1}([一-龠ぁ-ヶー]+([0-9]+(\-|‐|丁目|丁))*([0-9]+(\-|‐|番地|番))*([0-9]*[号]*))/is", $row['full_address'], $address);
